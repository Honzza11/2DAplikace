...
public class MapLegendPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        drawLegendItem(g2, "👿", "Enhanced Enemy", lx + 20, ly + yOffset + 90);
        drawLegendItem(g2, "🔥", "Rest Campfire", lx + 20, ly + yOffset + 120);
        drawLegendItem(g2, "💎", "Treasure", lx + 20, ly + yOffset + 150);
